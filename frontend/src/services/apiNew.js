// Complete mock API - this will override everything
const mockResponses = {
  '/api/v1/auth/login': {
    success: true,
...
const generateMockResponse = (url, data) => {
  console.log('🔥 NEW MOCK API call:', url, data);
